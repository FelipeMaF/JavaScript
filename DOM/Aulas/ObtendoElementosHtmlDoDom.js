/*
O DOM nos permite ler elementos especificos do documento HTML
*Obter vários elementos em uma HTMLCollection: document.getElementsByTagName() ou document.getElementsByClassName().

*Obter vários elementos em uma NodeList: document.getElementsByName() ou document.querySelectorAILL().

*Obtendo um unico elemento: document.getElementByld() ou document.querySelector().
